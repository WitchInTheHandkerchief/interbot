...
from interbot.services.messages_services import process_name_message, process_sponsor_message, \
    process_checking_sponsor_message, process_activity_message
...
async def process_activity(msg: Message, state: FSMContext) -> None:
    await process_activity_message(msg, state)
